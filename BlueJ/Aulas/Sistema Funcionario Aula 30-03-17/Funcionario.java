public abstract class Funcionario
{
    ...
    public Departamento getDepartamentoChefiado(){
        return this.departamentoChefiado;
    }
    
    public void setDepartamentoChefiado(Departamento departamentoChefiado){
        if(this.departamentoChefiado.getChefe() != null){
